        ...
        {document && (
          <main class="mt-10">
            ...
            <div class="flex flex-col lg:flex-row lg:space-x-12">
              <div class="px-4 lg:px-0 mt-12 text-gray-700 text-justify text-lg leading-relaxed w-full lg:w-3/4">
                <p class="pb-6">
                ...
                <div class="border-l-4 text-justify border-gray-500 pl-4 mb-6 italic rounded">
