    ...
    <div>
      <div
        ...
        style={{
          ...
          backgroundImage:
            "linear-gradient(180deg,transparent,rgba(0,0,0,2)),url('https://mdbootstrap.com/img/new/textures/full/171.jpg')",
          height: "250px",

          backgroundSize: "cover",
        }}
      >
        <h2 class="text-7xl font-bold mt-16 text-white text-center">
          Latest articles
        </h2>
      </div>
