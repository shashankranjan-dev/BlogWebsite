    ...
    <div>
      <section className=" dark:bg-gray-800 dark:text-gray-100">
        <div className=" max-w-7xl p-6 mx-auto space-y-6 sm:space-y-12">
          <div className="space-y-2  text-green-400 text-left">
          ...
          >
            ...
            <div className="p-6 space-y-2 lg:col-span-5">
              ...
              <p>
                ...
                in graece fuisset, eos affert putent doctus id.Mei ex aliquid
                eleifend forensibus, quo ad dicta apeirian neglegentur, ex has
                tantas percipit perfecto. At per tempor albucius perfecto, ei
                probatus consulatu patrioque mea, ei vocent delicata indoctum
                pri.
              </p>
            </div>
          </a>
