        ...
        <section class="mb-32 text-gray-800">
          <div
            ...
            style={{
              ...
              backgroundImage:
                "linear-gradient(180deg,transparent,rgba(0,0,0,2.5)),url('https://mdbootstrap.com/img/new/textures/full/171.jpg')",
              height: "300px",

              backgroundSize: "cover",
            }}
          >
            <h1 className="text-center mt-12 text-white font-bold text-7xl ">
              Get In Touch
            </h1>
          </div>
          <div class=" text-gray-800 px-4 md:px-64">
            <div
            ...
            >
              <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 mb-12">
                <div class="mb-12 lg:mb-0 text-center mx-auto">
                  <svg
                    class="w-8 h-8 text-zinc-900 mb-6 mx-auto"
                ...
                <div class="mb-12 lg:mb-0 text-center mx-auto">
                  ...
                  <h6 class="font-medium">New Delhi, 94126</h6>
                </div>
                <div class="mb-6 md:mb-0 text-center mx-auto">
                  ...
                  <h6 class="font-medium">+ 91 9667022458</h6>
                </div>
